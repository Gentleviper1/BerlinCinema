                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Add Shows</a></li>
        ...
        <div class="box-body">
          <form action="" method="post" id="form1">
            <div class="form-group">
              <label class="control-label"><h4>Select Movie</h4></label>
            ...
            <div class="form-group">
              <label class="control-label"><h4>Select Screen</h4></label>
            ...
            <div class="form-group">
              <label class="control-label"><h4>Select Show Times</h4></label>
            ...
            <div class="form-group">
              <label class="control-label"><h4>Start Date</h4></label>
