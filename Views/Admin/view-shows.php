                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">View Shows</a></li>
                                    ...
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>IMX</td>
                                                <td>12:00</td>
                                                <td><a href=""><button class="btn btn-danger">Stop Running</button></a>
                                                <a href=""><button class="btn btn-warning">Stop Show</button></a>
                                                </td>
                                           ...
                                           <tr>
                                                ...
                                                <td><a href=""><button class="btn btn-danger">Stop Running</button></a>
                                                <a href=""><button class="btn btn-warning">Stop Show</button></a>
                                               <!--<a href=""><button class="btn btn-success">Start Running</button></a>--> 
                                                </td>
