...
<head>
    ...
    <title>Berlin Cinema Dashboard</title>
</head>
...
<body>
                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <a class="dropdown-item" href="admin-account-settings.php"><i class="fas fa-cog mr-2"></i>Setting</a>
        ...
        <div class="nav-left-sidebar sidebar-dark">
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="d-xl-none d-lg-none" href="index.php">Admin Dashboard</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                              ...
                              <li class="nav-item ">
                                <a class="nav-link " href="admin-profile.php"  aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="fa fa-fw fa-users"></i>Profile <span class="badge badge-success">6</span></a>
                                 </li>
                             <li class="nav-divider">
                                Movies
                            </li>
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Total Movies</h5>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Total Theatres</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">$12099</h1>
                                        </div>
                                        <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Total Screenings</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">10</h1>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Recent Movies Added</h5>
                                            ...
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0">Movie Title</th>
                                                        <th class="border-0">Movie Id</th>
                                                        <th class="border-0">Genre</th>
                                                        <th class="border-0">Realease Date</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="badge-dot badge-success mr-1"></span>Now Showing</td>
                                                    </tr>
                                                    <tr>
                                                        <td>3</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="badge-dot badge-danger mr-1"></span>Coming Soon</td>
                                                    </tr>
                                                    <tr>
  ...
  <div class="col-xl-3 col-lg-12 col-md-6 col-sm-12 col-12">
                                ...
                                <!-- ============================================================== -->
                                <div class="card">
                                    <h5 class="card-header">Top Performing Movies</h5>
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted"> Ordered Tickets</h5>
                                        <div class="metric-value d-inline-block">
