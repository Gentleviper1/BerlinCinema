    ...
    <script>
        $(document).ready(function() {
            ...
            $('#savescreen').click(function() {
                ...
                // For now, just alert the values and close modal
                alert('Screen Name: ' + name + '\\nSeats: ' + seats + '\\nCharge: ' + charge);
                $('#addScreenModal').modal('hide');

                // TODO: Add AJAX call to save screen data to server
            });
            ...
            $('#saveShowTimes').click(function() {
                ...
                // For now, just alert the values and close modal
                alert('Movie: ' + movie + '\\nScreen: ' + screen + '\\nShow Times: ' + stime.join(', ') + '\\nStart Date: ' + sdate);
                $('#addShowTimesModal').modal('hide');

                // TODO: Add AJAX call to save show times to server
            });
        });
    </script>
</body>
