                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Movie Details</a></li>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Tiger Nixon</span> </td>
                                                <td><span class="badge  badge-success">Demo Screen</span></td>
                                                <td><span class="badge  badge-info">12:00</span></td>
                                                <td><span class="badge  badge-danger">2011/04/25</span></td>
                                            </tr>
                                            <tr>
                                                <td>Accountant</td>
                                                <td><span class="badge  badge-success">IMX Screen</span></td>
                                              <td><span class="badge  badge-info">12:00</span></td>
                                                 <td><span class="badge  badge-danger">2011/04/25</span></td>
                                            </tr>
                                           <tr>
