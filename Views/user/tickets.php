...
<body>
    ...
    <section class="tickets-section pt-60 pb-60">
        <div class="container">
            ...
            <form id="bookingForm" action="process_ticket.php" method="POST">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select theme-btn " id="showtimeSelect" name="showtime" required>
                                ...
                                <option value="10:00 AM">10:00 AM(noon)</option>
                                <option value="12:00 PM">12:00 AM (mid night)</option>
                        ...
                        <div class="mb-3">
                            ...
                            <p id="ticketPrice">$12.00</p>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Total Price</label>
                            <p id="totalPrice">$12.00</p>
                        </div>
                        <div class="d-grid">
